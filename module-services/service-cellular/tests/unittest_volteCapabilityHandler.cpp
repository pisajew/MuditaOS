...
TEST_CASE("VoLTE Capability handler")
{
    struct BaseChannelStub final: at::BaseChannel
    {
        ...
        virtual auto cmd(const std::string&,
                         std::chrono::milliseconds = at::default_timeout,
                         size_t = 0) -> at::Result { return at::Result{}; }
        virtual auto cmd(const at::AT&) -> at::Result { return at::Result{}; }
        virtual auto cmd(const at::Cmd&) -> at::Result { return at::Result{}; }
        ...
        virtual size_t cmdReceive(std::uint8_t *, std::chrono::milliseconds) { return 0; }
