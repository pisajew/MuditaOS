...
TEST_CASE("VoLTE handler test")
{
    ...
    SECTION("ThrowsAboutImsFailure_When_DisablingVolte_And_ImsSteeringCommandFailed")
    {
        ...
        REQUIRE_THROWS_WITH(handler.switchVolte(channel, true, false), Catch::Contains("fail") && Catch::Contains("IMS"));
    }
    ...
    SECTION("ThrowsAboutImsFailure_When_EnablingVolte_And_ImsSteeringCommandFailed")
    {
        ...
        REQUIRE_THROWS_WITH(handler.switchVolte(channel, true, true), Catch::Contains("fail") && Catch::Contains("IMS"));
    }
}
